...
<body onload="load()">
							...
							<div class="card-body">
								<form class="form-horizontal">
									<div class="form-group row">
										<div class="col-sm-9">
											<input id="researcher_id" type="hidden" value="0"
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input id="product_id" type="text" placeholder="product id"
												class="form-control form-control-warning">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-3 form-control-label">product
											name</label>
										<div class="col-sm-9">
	...
	<script src="ajax/Researcher.js"></script>
</body>
</html>
